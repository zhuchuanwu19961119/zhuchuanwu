...
class User extends Con
{
        ...
        if ($request->has('loginBtn')) {
            ...
            if ($user_name != null && $user_password != null && $Code != null) {
                ...
                if ($Verify->check($Code)) {
                    ...
                    echo '<script>window.location.href="/thinkphp5/public/index.php/bloguser/user/login" </script>';
                    exit();
                }
            } else {
        ...
        if ($request->has('regsterBtn')) {
            ...
            if ($user_name != null && $user_password != null && $user_passwords !=null) {
                ...
                if($temp>-1){
                    ...
                    echo '<script>window.location.href="/thinkphp5/public/index.php/bloguser/user/register" </script>';
                    exit();
                }
            } else {
                echo '<script> alert("有输入项为空!");</script>';
    ...
    public function regsterInsert($user_name,$user_password,$user_passwords){
        ...
        if ($Verify->check($Code)) {
            ...
            if($name!=null){
                ...
                echo '<script>window.location.href="/thinkphp5/public/index.php/blog/user/register" </script>';
                exit();
            }else{
                /*账号未被注册*/
    ...
    public function out()
    {
        if (Session::has('user_id')) {
            ...
            echo '<script>window.location.href="/thinkphp5/public/index.php/bloguser/blog/home" ;</script>';
        }else  echo '<script>window.location.href="/thinkphp5/public/index.php/bloguser/blog/home" ;</script>';
    }
