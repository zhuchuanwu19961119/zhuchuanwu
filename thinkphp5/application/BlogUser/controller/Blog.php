...
//                echo "<script> var Article=1; </script>";
        ...
        if(Session::has('user_id')){
            ...
            $this->assign([
                'Img'=>'<img src="/thinkphp5/public/static/img/ArticleInser.png" id="InserImg">',
            ]);
        ...
        if(isset($_POST['Btn'])){
            ...
            if($Title!=null && $Textarea!=null && $Title!='' && $Textarea!=''){
                ...
                if($Rtuen>-1 && $ArticleRutuen >-1){
                    echo "<script> alert('文章审核中!');window.location.href='/thinkphp5/public/index.php/bloguser/blog/home';</script>";
                }else {
                    echo "<script> alert('文章发布失败!');window.location.href='/thinkphp5/public/index.php/bloguser/blog/home';</script>";
                }

            }else echo "<script> alert('有输入项为null!');window.location.href='http://localhost/thinkphp5/public/index.php/bloguser/blog/home';</script>";
        }
    }
    ...
    public function Delete(){
        if(!empty($_GET['article_id'])){
            ...
            if($ReturuArticle>-1 && $ReturuComment>-1 && $ArticleRutuen>-1){
                echo '<script> alert(" 删除成功!");window.location.href="/thinkphp5/public/index.php/bloguser/blog/Home" </script>';
                exit();
            }else{
                echo '<script> alert(" 删除失败!");window.location.href="/thinkphp5/public/index.php/bloguser/blog/Home" </script>';
                exit();
            }
        }
    }
