<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:58:"/var/htmlroot/xcms/application/home/view/default/news.html";i:1523084273;s:65:"/var/htmlroot/xcms/application/home/view/default/public/head.html";i:1523079905;s:69:"/var/htmlroot/xcms/application/home/view/default/public/function.html";i:1503645978;s:67:"/var/htmlroot/xcms/application/home/view/default/public/config.html";i:1503645978;s:64:"/var/htmlroot/xcms/application/home/view/default/public/nav.html";i:1523184205;s:68:"/var/htmlroot/xcms/application/home/view/default/public/comment.html";i:1523084134;s:67:"/var/htmlroot/xcms/application/home/view/default/public/footer.html";i:1523077792;s:68:"/var/htmlroot/xcms/application/home/view/default/public/scripts.html";i:1523082488;}*/ ?>
<!DOCTYPE html>
  ...
  <div class="main-header">
    <div class="container">
      ...
      <div id="main-cmf">
          ...
          <div class="container">
            <div class="row page-title">
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-6">
                ...
                <div>
                  <span><?php echo date("Y-m-d H:i:s",$news_time); ?> by <a href="<?php echo url('home/Index/visit',array('id'=>$news_auto)); ?>" class="blog-entry-meta-author"><?php echo (isset($member_list_nickname) && ($member_list_nickname !== '')?$member_list_nickname:$member_list_username); ?></a></span>
		  <span>
		    <i class="fa fa-eye"> </i><?php echo $news_hits; ?>
		    <a href="<?php echo url('home/News/dolike',array('id'=>$n_id)); ?>" class="js-count-btn"><i class="fa fa-thumbs-up"> </i></a><span class="count"><?php echo $news_like; ?></span>
		    <a href="<?php echo url('home/News/dofavorite',array('id'=>$n_id)); ?>" class="js-favorite-btn" data-id="<?php echo $n_id; ?>" data-key="<?php echo get_favorite_key('news',$n_id); ?>">
            ...
            <div class="row">
              <div class="posts-block col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <article class="post hentry">
                  ...
                  <div class="post-content">
                    <b><?php echo lang('news copyright',[$news_source]); ?></b>
                  </div>
                  <?php endif; ?>
                  <div>
                    <?php if(!empty($prev)): ?>
                    <a href="<?php echo url('home/News/index',array('id'=>$prev['n_id'])); ?>" class="btn btn-primary pull-left"><?php echo lang('last news'); ?></a>
                    <?php endif; if(!empty($next)): ?>
                    <a href="<?php echo url('home/News/index',array('id'=>$next['n_id'])); ?>" class="btn btn-primary pull-right"><?php echo lang('next news'); ?></a>
                    <?php endif; ?>
                  </div>
                </article>
		...
		<?php if($t_open == 1): ?>
		<div class="reply">
  <h3 class="title"><?php echo lang('comments'); ?></h3>
</div>
<div class="comment-area" id="comments">
  <?php if(!empty($user['member_list_id'])): ?>
  <hr>
  <form class="form-horizontal comment-form" action="<?php echo url('home/Comment/runcomment'); ?>" method="post" data-id='111'>
    ...
    <div class="control-group" style="margin-top:10px;">
      <button type="submit" class="btn btn-primary"><?php echo lang('send comments'); ?></button>
    </div>
  ...
  <?php else: ?>
  <span>
    <?php echo lang('need login to comment'); ?> <a href="<?php echo url('home/Login/index'); ?>"><?php echo lang('login'); ?></a> | <a href="<?php echo url('home/Register/index'); ?>"><?php echo lang('register immediately'); ?></a>
  </span>
  <?php endif; if(!empty($user['member_list_id'])): ?>
  <script class="comment-tpl" type="text/html">
    <?php 
    if(empty($user['member_list_nickname'])){
    if(empty($user['member_list_username'])){
    $username="<?php echo lang('anonymous'); ?>";
    }else{
    ...
    $username=$user['member_list_nickname'];
     ...
     ?>
    <div class="comment" data-username="<?php echo $username; ?>" data-uid="<?php echo $user['member_list_id']; ?>">
      <a class="pull-left" href="<?php echo url('home/Index/visit',array('member_list_id'=>$user['member_list_id'])); ?>">
	<?php if(empty($user['member_list_headpic'])): ?>
	<img src="<?php echo $theme_path; ?>public/images/headicon.png" class="media-object avatar"/>
	<?php else: ?>
	<img src="<?php echo get_imgurl($user['member_list_headpic'],1); ?>" class="media-object avatar"/>
	<?php endif; ?>
      </a>
      <div class="comment-body">
	<div class="comment-content"><a href="<?php echo url('home/Index/visit',array('id'=>$user['member_list_id'])); ?>"><?php echo $username; ?>:</a><sapn class="toname"></sapn><span class="time"><?php echo lang('just'); ?></span> <a onclick="comment_reply(this);" href="javascript:;"><i class="fa fa-comment"></i></a></div>
  ...
  <script class="comment-reply-box-tpl" type="text/html">
	...
	<input type="text" class="textbox" placeholder="<?php echo lang('reply'); ?>" required>
      </div>
      <button class="btn" onclick="comment_cancel(this);"><?php echo lang('cancel'); ?></button>
      <button class="btn pull-right" onclick="comment_submit(this);"><?php echo lang('reply'); ?></button>
    </div>
  </script>
  <hr>
  <div class="comments" style="margin-top:50px;">
    ...
    <div class="comment" data-id="<?php echo $vo['c_id']; ?>" data-uid="<?php echo $vo['uid']; ?>" data-username="<?php echo (isset($vo['member_list_nickname']) && ($vo['member_list_nickname'] !== '')?$vo['member_list_nickname']:$vo['member_list_username']); ?>"  id="comment<?php echo $vo['c_id']; ?>">
      <a class="pull-left" href="<?php echo url('home/Index/visit',array('id'=>$vo['uid'])); ?>">
	<img src="<?php echo get_imgurl($vo['member_list_headpic'],1); ?>" class="media-object avatar"/>
      </a>
      <div class="comment-body">
	<div>
	  <a href="<?php echo url('home/Index/visit',array('id'=>$vo['uid'])); ?>"><?php echo (isset($vo['member_list_nickname']) && ($vo['member_list_nickname'] !== '')?$vo['member_list_nickname']:$vo['member_list_username']); ?>:</a><span class="time"><?php echo date('m-d  H:i',$vo['createtime']); ?></span> <a onclick="comment_reply(this);" href="javascript:;"><i class="fa fa-comment"></i></a></div>
	<div class="comment-content">
	  <span><?php echo $vo['c_content']; ?></span>
	</div>
	<?php if(!empty($vo['children'])): if(is_array($vo['children']) || $vo['children'] instanceof \think\Collection || $vo['children'] instanceof \think\Paginator): if( count($vo['children'])==0 ) : echo "" ;else: foreach($vo['children'] as $key=>$voo): ?>
	<div class="comment" data-id="<?php echo $voo['c_id']; ?>" data-uid="<?php echo $voo['uid']; ?>" data-username="<?php echo (isset($voo['member_list_nickname']) && ($voo['member_list_nickname'] !== '')?$voo['member_list_nickname']:$voo['member_list_username']); ?>" id="comment<?php echo $voo['c_id']; ?>" style="margin-left: 80px">
	  <a class="pull-left" href="<?php echo url('home/Index/visit',array('id'=>$voo['uid'])); ?>">
	    <img src="<?php echo get_imgurl($voo['member_list_headpic'],1); ?>" class="media-object avatar"/>
	  </a>
	  <div class="comment-body">
	    <div>
	      <a href="<?php echo url('home/Index/visit',array('id'=>$voo['uid'])); ?>"><?php echo (isset($voo['member_list_nickname']) && ($voo['member_list_nickname'] !== '')?$voo['member_list_nickname']:$voo['member_list_username']); ?>:</a><span><?php echo lang('reply'); ?> <a href="<?php echo url('home/Index/visit',array('id'=>$voo['to_uid'])); ?>"><?php echo (isset($parent_comments[$voo['parentid']]['member_list_nickname']) && ($parent_comments[$voo['parentid']]['member_list_nickname'] !== '')?$parent_comments[$voo['parentid']]['member_list_nickname']:$parent_comments[$voo['parentid']]['member_list_username']); ?></a></span><span class="time"><?php echo date('m-d  H:i',$voo['createtime']); ?></span> <a onclick="comment_reply(this);" href="javascript:;"><i class="fa fa-comment"></i></a>
	    </div>
	    <div class="comment-content">
	      <?php echo $voo['c_content']; ?>
	    </div>
	  </div>
	  <div class="clearfix"></div>
	</div>
