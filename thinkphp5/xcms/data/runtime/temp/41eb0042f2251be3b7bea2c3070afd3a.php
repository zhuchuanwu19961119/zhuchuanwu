<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:59:"/var/htmlroot/yfcms/application/home/view/default/list.html";i:1503645978;s:66:"/var/htmlroot/yfcms/application/home/view/default/public/head.html";i:1523076852;s:70:"/var/htmlroot/yfcms/application/home/view/default/public/function.html";i:1503645978;s:68:"/var/htmlroot/yfcms/application/home/view/default/public/config.html";i:1503645978;s:65:"/var/htmlroot/yfcms/application/home/view/default/public/nav.html";i:1523075886;s:64:"/var/htmlroot/yfcms/application/home/view/default/ajax_list.html";i:1503645978;s:73:"/var/htmlroot/yfcms/application/home/view/default/public/rightslider.html";i:1503645978;s:68:"/var/htmlroot/yfcms/application/home/view/default/public/footer.html";i:1503645978;s:69:"/var/htmlroot/yfcms/application/home/view/default/public/scripts.html";i:1503645978;}*/ ?>
<!DOCTYPE html>
...
<link rel="shortcut icon" href="<?php echo $theme_path; ?>public/images/favicon.ico">
	...
	<article class="post hentry">
		<?php if($vo['news_img']): ?>
			<div class="post-image">
				<a href="<?php echo get_imgurl($vo['news_img']); ?>" data-rel="prettyPhoto">
					<span class="img-hover"></span>
					<span class="fullscreen"><i class="fa fa-search"></i></span>
					<img src="<?php echo get_imgurl($vo['news_img']); ?>">
				</a>
			</div>
		<?php else: $img_no=rand(1,8); ?>
			<div class="post-image">
				<a href="<?php echo $yf_theme_path; ?>public/images/default_tupian<?php echo $img_no; ?>.jpg" data-rel="prettyPhoto">
					<span class="img-hover"></span>
					<span class="fullscreen"><i class="fa fa-search"></i></span>
					<img src="<?php echo $yf_theme_path; ?>public/images/default_tupian<?php echo $img_no; ?>.jpg"/>
				</a>
			</div>
		<?php endif; ?>
		<div class="post-content-wrap">
			<header class="post-header">
				<div class="post-date">
					<a class="date" href="#"><strong><?php echo date("d",$vo['news_time']); ?></strong><i><?php echo date("M",$vo['news_time']); ?></i></a>
				</div>
				<h3 class="content-title"><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><?php echo $vo['news_title']; ?></a></h3>
				<div class="blog-entry-meta">
					<div class="blog-entry-meta-author">
						<i class="fa fa-user"></i>
						<a href="<?php echo url('home/Index/visit',array('id'=>$vo['news_auto'])); ?>" class="blog-entry-meta-author"><?php echo (isset($vo['member_list_nickname']) && ($vo['member_list_nickname'] !== '')?$vo['member_list_nickname']:$vo['member_list_username']); ?></a>
					</div>
					<div class="blog-entry-meta-comments">
						<a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>#comments"><i class="fa fa-comment"></i></a><?php echo $vo['comment_count']; ?>
					</div>
					<div class="blog-entry-meta-comments">
						<i class="fa fa-eye"></i>
						<?php echo $vo['news_hits']; ?>
					</div>
					<div class="blog-entry-meta-comments">
						<a href="<?php echo url('home/News/dolike',array('id'=>$vo['n_id'])); ?>" class="js-count-btn"><i class="fa fa-thumbs-up"> </i></a><span class="count"><?php echo $vo['news_like']; ?></span>
					</div>
			...
			<div class="post-content">
				<p><?php echo html_trim($vo['news_content'],100); ?></p>
...
<div class="pagination-centered">
    ...
    <div class="widget tabs">
        <div id="horizontal-tabs">
            <ul class="tabs">
                <li id="tab1" class="current"><?php echo lang('hot articles'); ?></li>
                <li id="tab2"><?php echo lang('recent articles'); ?></li>
                <li id="tab3"><?php echo lang('recent comments'); ?></li>
            </ul>
            <div class="contents">
                <div class="tabscontent" id="content1" style="display: block;">
                    <ul class="posts">
						<?php $hot_articles=get_news("cid:$portal_hot_articles;field:news_title,news_time,news_scontent,n_id,news_img;limit:5;order:news_hits desc",false,10,"null","");if(is_array($hot_articles) || $hot_articles instanceof \think\Collection || $hot_articles instanceof \think\Paginator): if( count($hot_articles)==0 ) : echo "" ;else: foreach($hot_articles as $key=>$vo): ?>
                        <li>
                            <a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><img class="img-thumbnail recent-post-img" alt="" src="<?php echo get_imgurl($vo['news_img']); ?>"></a>
                            <p><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><?php echo msubstr($vo['news_title'],0,20); ?></a></p>
                            <span class="color"><?php echo date("Y-m-d",$vo['news_time']); ?></span>
                        </li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="tabscontent" id="content2">
                    <ul class="posts">
						<?php $last_post=get_news("cid:$portal_last_post;field:news_title,news_time,news_scontent,n_id,news_img;limit:5;order:news_time desc",false,10,"null","");if(is_array($last_post) || $last_post instanceof \think\Collection || $last_post instanceof \think\Paginator): if( count($last_post)==0 ) : echo "" ;else: foreach($last_post as $key=>$vo): ?>
                        <li>
                            <a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><img class="img-thumbnail recent-post-img" alt="" src="<?php echo get_imgurl($vo['news_img']); ?>"></a>
                            <p><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><?php echo msubstr($vo['news_title'],0,20); ?></a></p>
                            <span class="color"><?php echo date("Y-m-d",$vo['news_time']); ?></span>
                ...
                <div class="tabscontent" id="content3">
                    <ul class="posts">
						<?php $last_comments=get_comments("limit:5;order:createtime desc");if(is_array($last_comments) || $last_comments instanceof \think\Collection || $last_comments instanceof \think\Paginator): if( count($last_comments)==0 ) : echo "" ;else: foreach($last_comments as $key=>$vo): ?>
                            <li>
								<a class="pull-left" href="<?php echo url('home/News/index',array('id'=>$vo['t_id'])); ?>" title="<?php echo lang('see'); ?>">
									<img src="<?php echo get_imgurl($vo['member_list_headpic'],1); ?>" class="img-thumbnail recent-post-img"/>
								</a>
                                <i class="fa fa-comment"></i>
                                <a href="<?php echo url('home/Index/visit',array('id'=>$vo['uid'])); ?>"><?php echo (isset($vo['member_list_nickname']) && ($vo['member_list_nickname'] !== '')?$vo['member_list_nickname']:$vo['member_list_username']); ?>:</a>
                                <p><?php echo htmlspecialchars($vo['c_content']); ?></p>
                                <span class="comment-time"><?php echo date("Y-m-d H:i:s",$vo['createtime']); ?></span>
    ...
    <div class="widget ads">
        <h3 class="title"><?php echo lang('ads contribution'); ?></h3>
        <div class="ads-img row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <img class="img-thumbnail" alt="" src="<?php echo $yf_theme_path; ?>public/images/ads-small.jpg">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <img class="img-thumbnail" alt="" src="<?php echo $yf_theme_path; ?>public/images/ads-small.jpg">
            </div>
