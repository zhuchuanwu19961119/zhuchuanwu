            ...
            if ($Text != null || $Text != '') {
                ...
                if (Session::has('user_id')) {
                    ...
                    if($CommentRutuen>-1 && $ArticleRutuen>-1 && $MessageRutuen>-1){
                        echo '<script> alert("评论成功!");window.location.href="/public/index.php/bloguser/Details/Home?id='.$article_id.'&state=1" </script>';
                    } else echo '<script> alert("评论失败!");window.location.href="/public/index.php/bloguser/Details/Home?id='.$article_id.'&state=1" </script>';
                } else echo "<script> alert('当前尚未登录账号!');window.location.href='/public/index.php/bloguser/blog/Home';</script>";
